...
valor_das_horas = float(input("Informe o valor da hora de trabalho: "))
quantidade_de_horas_trabalhadas = float(input("Informe a quantidade de horas trabahadas: "))

salario = valor_das_horas * quantidade_de_horas_trabalhadas
